"""
fig_consciousness_regime_F.py — Actualization free energy and consciousness attractor
...
Run: python fig_consciousness_regime_F.py
"""
...
def main():
    ...
    plt.tight_layout()
    save(fig, 'fig_consciousness_regime_F.png')
