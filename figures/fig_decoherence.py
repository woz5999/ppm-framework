"""
fig_decoherence.py — Gravitational decoherence prediction

Plots decoherence time τ_dec = 2ℏ²/(Gm³c) across a wide range of masses,
marking specific particles and showing experimental/observational timescales.
"""
...
from _style import apply_style, new_figure, save, GOLD, WHITE, VIOLET, CYAN, GRAY, RED
...
ax.axhline(AGE_UNIVERSE_S, color=GRAY, linestyle='--', linewidth=2, alpha=0.7,
          label=f'Age of universe: {AGE_UNIVERSE_S:.2e} s')
ax.axhline(1.0, color=GRAY, linestyle='--', linewidth=2, alpha=0.7,
          label='1 second')
ax.axhline(PLANCK_TIME_S, color=GRAY, linestyle='--', linewidth=2, alpha=0.7,
